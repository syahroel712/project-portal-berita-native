<div class="row">
    ...
    $ambil_data = $koneksi->query("SELECT * FROM tb_berita JOIN tb_kategori ON tb_kategori.kategori_id=tb_berita.kategori_id WHERE tb_berita.kategori_id = $id
    ORDER BY berita_tanggal DESC LIMIT " . $limit . "," . $per_hal);

    // $ambil_data = $koneksi->query("SELECT * FROM tb_berita,tb_kategori
    // WHERE tb_kategori.kategori_id=tb_berita.kategori_id
    // AND tb_berita.kategori_id = '$id'
